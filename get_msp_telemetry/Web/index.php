...
//         return '';
       ...
       // MtM: make video as wide as possible, stretch if needed
...
<html>
   <head>
      ...
      <script language="javascript">
         function init_intercept(mjpeg, video_fps, divider) {
             
             updateTelemetry();
             
             init(mjpeg, video_fps, divider);
         }
      </script>
   </head>
   <body onload="setTimeout('init_intercept(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
     ...
     <div class="container-fluid text-center liveimage">
         ...
         <div id="telemetry" <?php echo $displayStyle; ?> >
            <table style="width: 100%; border: 1px solid #000;"><tbody id="telemetry_tbody">
                <tr><td>Batt</td><td>12.0</td><td>a</td><td>b</td></tr>
            </tbody></table>
         </div>
