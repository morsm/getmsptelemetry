...
// MtM 23-01-2016: function to update telemetry xml using AJAX
function updateTelemetry()
{
    new Transformation().setXml("telemetry/telemetry.xml").setXslt("telemetry.xsl").transform("telemetry_tbody");
}
...
ajax_status.onreadystatechange = function() {
  if(ajax_status.readyState == 4 && ajax_status.status == 200) {
    ...
    else if (ajax_status.responseText == "telemetry") {
        updateTelemetry();
    }
